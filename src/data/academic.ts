...
export const academicClients: string[][] = [];
export const academicTasks: string[][] = [];
export const academicGoals: string[][] = [];
export const academicProjectStatus: { name: string; value: number; pct: string; color: string }[] = [];
export const academicDeadlines: string[][] = [];
export const academicRevenueServices: string[][] = [];
